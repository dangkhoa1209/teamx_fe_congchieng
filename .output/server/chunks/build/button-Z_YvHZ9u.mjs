  ...
  setup(__props, { emit: __emit }) {
      ...
      if (outline.value) {
        ...
        if (theme.value === "main") {
          ...
          results.push(
            ...
            // hover thì border đổi màu primary
          );
        }
      }
      if (uppercase.value) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<button${ssrRenderAttrs(mergeProps({
        class: ["font-robo text-[16px] font-medium h-[48px] rounded-[24px] transition-colors", cClass.value],
        type: __props.type,
        disabled: __props.disabled
      }, _attrs))}><div class="px-10">`);
...
//# sourceMappingURL=button-Z_YvHZ9u.mjs.map
