...
const _sfc_main = {
  __name: "xa-dam-rong-4",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        title: "Tin t\u1EE9c n\u1ED5i b\u1EADt X\xE3 \u0110am R\xF4ng 4",
        type: "xa-dam-rong-4"
      }, _attrs), null, _parent));
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/tin-tuc-su-kien/tin-noi-bat/xa-dam-rong-4.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=xa-dam-rong-4-CK6E3sqh.mjs.map
