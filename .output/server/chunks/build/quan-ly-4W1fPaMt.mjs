...
import { _ as _sfc_main$3 } from './button-CrDZtTTe.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$4 } from './data-table-pagination-3APMMkBT.mjs';
...
import { _ as __unimport_$newScope, a as _sfc_main$5 } from './action-DEjOIFr6.mjs';
import { _ as __unimport_$formatter } from './_formatter-Dlp1HBct.mjs';
import _sfc_main$6 from './delete-qvE1M9Uw.mjs';
...
import './modal-action-DckAiepO.mjs';
import './index-XektXWz7.mjs';
import './_toast-BM3znq4X.mjs';
import './select-Dd8N0ztl.mjs';
import './input-BXuQFPXT.mjs';
import './text-area-BfIJ74Ab.mjs';
import './image-CfPwRy5O.mjs';
import 'cropperjs';
import './permission-check-C6PQsERQ.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_x_content_place, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${_scopeId}><div class="flex flex-wrap items-center justify-between gap-3 mb-2"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-semibold text-gray-900"${_scopeId}>Qu\u1EA3n l\xFD tin t\u1EE9c - s\u1EF1 ki\u1EC7n</h1></div>`);
            ...
            _push2(`</div><div class="rounded-xl border border-gray-200 bg-main shadow-sm"${_scopeId}>`);
...
//# sourceMappingURL=quan-ly-4W1fPaMt.mjs.map
