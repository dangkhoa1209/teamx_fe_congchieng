...
import { m as menus, M as Menu } from './index-D0kmpyH1.mjs';
...
import { $ as $api, a as $url } from './_url-F9nTLVFG.mjs';
...
import './change-password-Bd39lOQ3.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><header class="relative z-50" data-v-382cc321><div class="bg-primary relative" data-v-382cc321>`);
      _push(ssrRenderComponent(_component_x_content_place, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex items-center justify-between py-2 tablet:py-6 laptop:py-8" data-v-382cc321${_scopeId}><div class="flex items-center gap-4 laptop:gap-10" data-v-382cc321${_scopeId}><div class="h-8 w-8 tablet:h-18 tablet:w-18 laptop:h-20 laptop:w-20" data-v-382cc321${_scopeId}><img${ssrRenderAttr("src", _imports_0)} class="w-full h-full object-contain" data-v-382cc321${_scopeId}></div><div class="text-main" data-v-382cc321${_scopeId}><p class="font-mont font-semibold text-[12px] tablet:text-[16px] laptop:text-[20px] leading-tight" data-v-382cc321${_scopeId}> UBND T\u1EC8NH L\xC2M \u0110\u1ED2NG </p><p class="font-mont font-semibold text-[12px] tablet:text-[22px] laptop:text-[28px] leading-tight" data-v-382cc321${_scopeId}> S\u1EDE V\u0102N HO\xC1, TH\u1EC2 THAO V\xC0 DU L\u1ECACH </p></div></div><div class="flex items-center gap-4 laptop:hidden" data-v-382cc321${_scopeId}><button class="p-2" data-v-382cc321${_scopeId}>`);
              ...
              createVNode("div", { class: "flex items-center justify-between py-2 tablet:py-6 laptop:py-8" }, [
                createVNode("div", { class: "flex items-center gap-4 laptop:gap-10" }, [
                  ...
                  createVNode("div", { class: "text-main" }, [
                    ...
                    createVNode("p", { class: "font-mont font-semibold text-[12px] tablet:text-[22px] laptop:text-[28px] leading-tight" }, " S\u1EDE V\u0102N HO\xC1, TH\u1EC2 THAO V\xC0 DU L\u1ECACH ")
                  ])
                ]),
      ...
      _push(`<div class="absolute inset-0 pointer-events-none" data-v-382cc321><div class="max-w-[1440px] mx-auto h-full flex justify-end" data-v-382cc321>`);
      _push(ssrRenderComponent(unref(IconHeader), { class: "h-full text-primary" }, null, _parent));
      _push(`</div></div></div>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (isDrawerOpen.value) {
          _push2(`<div class="fixed inset-0 z-[9999]" data-v-382cc321><div class="absolute inset-0 bg-black/50" data-v-382cc321></div><div class="${ssrRenderClass([isDrawerOpen.value ? "translate-x-0" : "translate-x-full", "absolute inset-y-0 right-0 w-full max-w-md bg-main shadow-2xl flex flex-col pointer-events-auto translate-x-0 transition-transform duration-300 ease-out"])}" data-v-382cc321><div class="bg-primary px-4 h-[58.5px] tablet:h-[102.5px] flex items-center justify-between" data-v-382cc321><div class="flex items-center gap-4" data-v-382cc321><div class="h-8 w-8 tablet:h-16 tablet:w-16" data-v-382cc321><img${ssrRenderAttr("src", _imports_0)} class="w-full h-full object-contain" data-v-382cc321></div><div class="text-main" data-v-382cc321><p class="font-mont text-[12px] font-semibold leading-tight" data-v-382cc321> UBND T\u1EC8NH L\xC2M \u0110\u1ED2NG </p><p class="font-mont text-[12px] font-semibold leading-tight" data-v-382cc321> S\u1EDE V\u0102N HO\xC1, TH\u1EC2 THAO V\xC0 DU L\u1ECACH </p></div></div><button class="p-2" data-v-382cc321>`);
          _push2(ssrRenderComponent(_component_Icon, {
            name: "heroicons:x-mark",
            class: "w-6 h-6 text-main"
          }, null, _parent));
          _push2(`</button></div><nav class="flex-1 overflow-y-auto" data-v-382cc321>`);
          _push2(ssrRenderComponent(_sfc_main$2, {
            menus: unref(menus),
            onClose: ($event) => isDrawerOpen.value = false
          }, null, _parent));
          _push2(`</nav><div class="my-10 flex justify-center" data-v-382cc321>`);
      ...
      _push(`</header><div class="sticky top-0 z-40 bg-main laptop:block hidden" data-v-382cc321>`);
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-382cc321"]]);

export { Header as default };
//# sourceMappingURL=index-BuZjM1Ir.mjs.map
