...
import { _ as _sfc_main$2 } from './button-CrDZtTTe.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$3 } from './data-table-pagination-3APMMkBT.mjs';
...
import _sfc_main$4 from './action-kcyi5wRT.mjs';
import _sfc_main$5 from './update-permission-BO_9ICqw.mjs';
import _sfc_main$6 from './update-password-4PpK-7Ax.mjs';
import _sfc_main$7 from './delete-B3fbfiQh.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_x_data_table_pagination = _sfc_main$3;
      _push(ssrRenderComponent(_component_x_content_place, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div${_scopeId}><div class="flex flex-wrap items-center justify-between gap-3 mb-2"${_scopeId}><div${_scopeId}><h1 class="text-2xl font-semibold text-gray-900"${_scopeId}>Qu\u1EA3n l\xFD t\xE0i kho\u1EA3n</h1></div>`);
...
//# sourceMappingURL=index-Dl3c9bWr.mjs.map
