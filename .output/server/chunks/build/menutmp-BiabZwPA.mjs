...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "h-[75px]" }, _attrs))} data-v-a36e986d><div class="h-0" data-v-a36e986d></div><header class="h-[75px]" data-v-a36e986d><div class="${ssrRenderClass([{ "fixed-header": unref(isFixed) }, "header z-50 bg-main"])}" data-v-a36e986d>`);
      _push(ssrRenderComponent(_component_x_content_place, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="flex justify-between items-center h-[75px]" data-v-a36e986d${_scopeId}><ul class="flex gap-[52px] uppercase text-[16px] font-robo font-medium" data-v-a36e986d${_scopeId}><!--[-->`);
            ssrRenderList(menus, (item) => {
              _push2(`<li class="cursor-pointer hover:text-secondary" data-v-a36e986d${_scopeId}>`);
              _push2(ssrRenderComponent(_component_x_link, {
                to: item.page
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<span class="text-primary" data-v-a36e986d${_scopeId2}>${ssrInterpolate(item.label)}</span>`);
                  } else {
                    return [
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/admin/header/menutmp.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const menutmp = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a36e986d"]]);

export { menutmp as default };
//# sourceMappingURL=menutmp-BiabZwPA.mjs.map
