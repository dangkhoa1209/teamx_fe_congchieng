...
import { _ as _sfc_main$3 } from './line-Cl7qy73P.mjs';
import { _ as _sfc_main$4 } from './image-DeCRukUU.mjs';
import { a as _sfc_main$5, _ as _sfc_main$1$1 } from './core-ttnb-BkzLb_3Y.mjs';
      ...
      _push(ssrRenderComponent(_component_x_content_place, mergeProps({ class: "font-robo text-body" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div${_scopeId}><h2 class="font-bold text-body text-primary"${_scopeId}>TIN T\u1EE8C - S\u1EF0 KI\u1EC6N</h2>`);
            ...
            if (unref(newsData)) {
              _push2(`<div class="flex gap-[40px]"${_scopeId}><section${_scopeId}><div class="flex justify-between align-middle mt-5"${_scopeId}><div${_scopeId}><span class=""${_scopeId}>${ssrInterpolate(("$formatter" in _ctx ? _ctx.$formatter : unref(__unimport_$formatter))().formatVNTime(unref(newsData).createdAt))}</span></div><div class="flex gap-4"${_scopeId}><div class="border border-primary hover:border-primary hover:bg-primary hover:text-main p-2 rounded-full box-border cursor-pointer group"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(FBIcon), { class: "h-4 w-4 laptop:w-5 laptop:h-5 fill-current text-primary group-hover:text-main" }, null, _parent2, _scopeId));
              _push2(`</div><div class="border border-primary hover:border-primary hover:bg-primary hover:text-main p-2 rounded-full box-border cursor-pointer group"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(YTIcon), { class: "h-4 w-4 laptop:w-5 laptop:h-5 fill-current text-primary group-hover:text-main" }, null, _parent2, _scopeId));
              _push2(`</div><div class="border border-primary hover:border-primary hover:bg-primary hover:text-main p-2 rounded-full box-border cursor-pointer group"${_scopeId}>`);
              _push2(ssrRenderComponent(unref(IGIcon), { class: "h-4 w-4 laptop:w-5 laptop:h-5 fill-current text-primary group-hover:text-main" }, null, _parent2, _scopeId));
              _push2(`</div></div></div>`);
              ...
              _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
              _push2(`<h3 class="font-bold text-primary text-subtitle"${_scopeId}>${ssrInterpolate(unref(newsData).subtitle)}</h3>`);
              _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
              _push2(`<!--[-->`);
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    ...
                    if (_push3) {
                      if (content.type == "content-in-dam") {
                        _push3(`<div${_scopeId2}><pre class="font-bold whitespace-pre-line font-robo text-subtitle text-justif"${_scopeId2}>${ssrInterpolate(content.data)}</pre>`);
                      ...
                      return [
                        content.type == "content-in-dam" ? (openBlock(), createBlock("div", { key: 0 }, [
                          createVNode("pre", { class: "font-bold whitespace-pre-line font-robo text-subtitle text-justif" }, toDisplayString(content.data), 1),
              ...
              _push2(`<section class="w-full max-w-[400px] block laptop:hidden"${_scopeId}><div${_scopeId}><h2 class="font-bold text-subtitle text-primary mt-5 leading-[40px]"${_scopeId}> TIN T\u1EE8C N\u1ED4I B\u1EACT </h2>`);
              _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
              ...
              _push2(ssrRenderComponent(_component_x_space, { height: 80 }, null, _parent2, _scopeId));
              _push2(`</section><section class="w-full min-w-[400px] hidden laptop:block"${_scopeId}><div${_scopeId}><h2 class="font-bold text-subtitle text-primary mt-5 leading-[40px]"${_scopeId}>TIN T\u1EE8C N\u1ED4I B\u1EACT</h2>`);
              _push2(ssrRenderComponent(_component_x_space, { height: 15 }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_x_line, null, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_x_core_ttnb, null, {
            ...
            return [
              ...
              createVNode("div", null, [
                createVNode("h2", { class: "font-bold text-body text-primary" }, "TIN T\u1EE8C - S\u1EF0 KI\u1EC6N"),
              ...
              unref(newsData) ? (openBlock(), createBlock("div", {
                ...
                createVNode("section", null, [
                  createVNode("div", { class: "flex justify-between align-middle mt-5" }, [
                    createVNode("div", null, [
                      createVNode("span", { class: "" }, toDisplayString(("$formatter" in _ctx ? _ctx.$formatter : unref(__unimport_$formatter))().formatVNTime(unref(newsData).createdAt)), 1)
                    ]),
                    createVNode("div", { class: "flex gap-4" }, [
                      createVNode("div", { class: "border border-primary hover:border-primary hover:bg-primary hover:text-main p-2 rounded-full box-border cursor-pointer group" }, [
                        createVNode(unref(FBIcon), { class: "h-4 w-4 laptop:w-5 laptop:h-5 fill-current text-primary group-hover:text-main" })
                      ]),
                      createVNode("div", { class: "border border-primary hover:border-primary hover:bg-primary hover:text-main p-2 rounded-full box-border cursor-pointer group" }, [
                        createVNode(unref(YTIcon), { class: "h-4 w-4 laptop:w-5 laptop:h-5 fill-current text-primary group-hover:text-main" })
                      ]),
                      createVNode("div", { class: "border border-primary hover:border-primary hover:bg-primary hover:text-main p-2 rounded-full box-border cursor-pointer group" }, [
                        createVNode(unref(IGIcon), { class: "h-4 w-4 laptop:w-5 laptop:h-5 fill-current text-primary group-hover:text-main" })
                      ])
                    ])
                  ]),
                  ...
                  createVNode(_component_x_space, { height: 40 }),
                  createVNode("h3", { class: "font-bold text-primary text-subtitle" }, toDisplayString(unref(newsData).subtitle), 1),
                  createVNode(_component_x_space, { height: 40 }),
                  ...
                  createVNode("section", { class: "w-full max-w-[400px] block laptop:hidden" }, [
                    createVNode("div", null, [
...
//# sourceMappingURL=index-kUTxwrgX.mjs.map
