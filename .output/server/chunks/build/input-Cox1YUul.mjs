import __nuxt_component_1$1 from './index-CyZG15Sy.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col w-full" }, _attrs))} data-v-10ca9d80>`);
      if (__props.label) {
        _push(`<label${ssrRenderAttr("for", __props.name)} class="mb-1 text-body font-medium font-robo" data-v-10ca9d80>${ssrInterpolate(__props.label)} `);
        if (__props.required) {
          _push(`<span class="ml-0.5 text-red-500" data-v-10ca9d80>*</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</label>`);
      ...
      _push(ssrRenderComponent(unref(Field), {
        ...
        default: withCtx(({ field, errors }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative w-full" data-v-10ca9d80${_scopeId}><input${ssrRenderAttr("id", __props.name)}${ssrRenderAttr("type", inputType.value)}${ssrRenderAttr("placeholder", __props.placeholder)}${ssrIncludeBooleanAttr(__props.disabled) ? " disabled" : ""}${ssrIncludeBooleanAttr(__props.readonly) ? " readonly" : ""}${ssrRenderAttr("min", __props.min)}${ssrRenderAttr("max", __props.max)}${ssrRenderAttr("value", field.value)} class="w-full rounded-xl tablet:rounded-2xl border py-1 px-2 tablet:px-4 tablet:py-2 h-[35px] tablet:h-[60px] transition-colors duration-200 outline-none bg-main border-primary hover:border-primary focus:ring-2 focus:ring-primary disabled:bg-gray-100 disabled:cursor-not-allowed text-body font-medium font-robo" data-v-10ca9d80${_scopeId}>`);
            if (isPasswordType.value) {
              _push2(`<button type="button" class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700" data-v-10ca9d80${_scopeId}>`);
            ...
            _push2(`</div>`);
            if (errors[0]) {
              _push2(`<p class="mt-1 text-sm text-red-500" data-v-10ca9d80${_scopeId}>${ssrInterpolate(errors[0])}</p>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
      ...
      if (__props.description) {
        _push(`<p class="mt-1 text-sm text-gray-500" data-v-10ca9d80>${ssrInterpolate(__props.description)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-10ca9d80"]]);

export { __nuxt_component_1 as _ };
//# sourceMappingURL=input-Cox1YUul.mjs.map
