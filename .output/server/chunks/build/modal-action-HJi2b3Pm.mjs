    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (__props.modelValue) {
          _push2(`<div class="fixed inset-0 z-[2000] flex items-center justify-center bg-black/40" tabindex="-1"><div class="w-full max-w-[min(70vw,1440px)] max-h-[90vh] overflow-hidden rounded-xl bg-main shadow-lg flex flex-col transition-all duration-150 ease-out scale-100" role="dialog" aria-modal="true"><div class="flex items-center justify-between border-b border-gray-200 px-6 py-4"><h2 class="text-lg font-semibold text-gray-900 truncate">${ssrInterpolate(__props.title)}</h2><button type="button" class="rounded-full p-2 text-gray-500 hover:bg-gray-100">`);
...
//# sourceMappingURL=modal-action-HJi2b3Pm.mjs.map
