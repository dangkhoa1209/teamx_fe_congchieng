...
import { _ as _sfc_main$7 } from './index-CthfZhJC.mjs';
import { _ as _sfc_main$9 } from './line-ByzM3RBl.mjs';
import { ref, mergeProps, unref, withCtx, createTextVNode, createVNode, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent } from 'vue/server-renderer';
import _sfc_main$8 from './xa-CMheerGJ.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "user-select-none" }, _attrs, {
        style: unref(show) ? null : { display: "none" }
      }))}><div class="max-w-[1440px] mx-auto"><section class="relative">`);
      _push(ssrRenderComponent(_component_x_image, {
        path: (_a = unref(image)) == null ? void 0 : _a.banner,
      ...
      _push(ssrRenderComponent(_component_x_content_place, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_x_space, { height: 50 }, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_sfc_main$8, { image: unref(image) }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(_component_x_title, {
                "class-name": "font-robo font-bold text-title",
              ...
              createVNode(_component_x_space, { height: 50 }),
              createVNode(_sfc_main$8, { image: unref(image) }, null, 8, ["image"])
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-M28chc6r.mjs.map
