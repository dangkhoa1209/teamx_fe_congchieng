      ...
      _push(ssrRenderComponent(_component_x_content_place, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div></div><div class="w-[100%] laptop:w-[25%] flex flex-col gap-6"${_scopeId}><p class="font-medium text-subtitle"${_scopeId}>DANH M\u1EE4C</p><p class="font-normal text-body cursor-pointer"${_scopeId}> Gi\u1EDBi thi\u1EC7u v\u1EC1 chuy\xEAn trang </p><p class="font-normal text-body cursor-pointer"${_scopeId}> Ti\u1EC1m n\u0103ng ph\xE1t tri\u1EC3n </p><p class="font-normal text-body cursor-pointer"${_scopeId}> V\u0103n h\xF3a c\u1ED3ng chi\xEAng </p><p class="font-normal text-body cursor-pointer"${_scopeId}> Tin t\u1EE9c - S\u1EF1 ki\u1EC7n </p><p class="font-normal text-body cursor-pointer"${_scopeId}>H\u1EE3p t\xE1c</p></div><div class="w-[100%] laptop:w-[35%] flex flex-col gap-6"${_scopeId}><p class="font-medium text-subtitle"${_scopeId}>LI\xCAN H\u1EC6</p><p class="font-normal text-body"${_scopeId}> Ban Bi\xEAn t\u1EADp Chuy\xEAn Trang th\xF4ng tin \u0111i\u1EC7n t\u1EED - S\u1EDF V\u0103n h\xF3a, Th\u1EC3 thao v\xE0 Du l\u1ECBch t\u1EC9nh L\xE2m \u0110\u1ED3ng </p><p class="font-normal text-body"${_scopeId}> \u0110\u1ECBa ch\u1EC9: T\u1EA7ng 2 khu 9 t\u1EA7ng, S\u1ED1 36 Tr\u1EA7n Ph\xFA, Ph\u01B0\u1EDDng Xu\xE2n H\u01B0\u01A1ng \u0110\xE0 L\u1EA1t - T\u1EC9nh L\xE2m \u0110\u1ED3ng </p><p class="font-normal text-body"${_scopeId}>S\u1ED1 \u0111i\u1EC7n tho\u1EA1i: (0263) 3822141</p><p class="font-normal text-body"${_scopeId}>Email: svhttdl.lamdong.gov.vn</p></div></div>`);
            _push2(ssrRenderComponent(_component_x_space, { height: 58 }, null, _parent2, _scopeId));
            ...
            return [
              ...
              createVNode("div", { class: "flex gap-16 flex-col laptop:flex-row" }, [
                ...
                createVNode("div", { class: "w-[100%] laptop:w-[25%] flex flex-col gap-6" }, [
                ...
                createVNode("div", { class: "w-[100%] laptop:w-[35%] flex flex-col gap-6" }, [
...
//# sourceMappingURL=index-CkumrpjK.mjs.map
