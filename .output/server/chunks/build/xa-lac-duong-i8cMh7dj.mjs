  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        title: "Tin t\u1EE9c n\u1ED5i b\u1EADt X\xE3 L\u1EA1c D\u01B0\u01A1ng",
        type: "xa-lac-duong"
      }, _attrs), null, _parent));
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/tin-tuc-su-kien/tin-noi-bat/xa-lac-duong.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=xa-lac-duong-i8cMh7dj.mjs.map
