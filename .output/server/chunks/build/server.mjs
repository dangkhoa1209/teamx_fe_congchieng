...
const _routes = [
  {
    ...
    children: [
      ...
      },
      {
        name: "admin-ca-nhan",
        path: "ca-nhan",
        component: () => import('./index-Cm562MHa.mjs')
      },
      {
        name: "admin-tai-khoan",
        path: "tai-khoan",
        component: () => import('./index-Dl3c9bWr.mjs')
      },
      {
  ...
  },
  {
    name: "lien-he",
    path: "/lien-he",
    component: () => import('./index-O3qJa3z4.mjs')
  },
  {
    name: "tim-kiem",
    path: "/tim-kiem",
    component: () => import('./index-CJg2K9ck.mjs')
  },
  {
    name: "slugify",
    path: "/:slugify()",
    component: () => import('./index-6KocfSiY.mjs')
  },
  {
    name: "trang-chu",
    path: "/trang-chu",
