import { _ as _sfc_main$1 } from './link-r8bg-CCq.mjs';
import { _ as _sfc_main$2 } from './line-CYB7w7Wn.mjs';
import { ref, computed, watch, nextTick, resolveComponent, mergeProps, withCtx, createVNode, toDisplayString, useSSRContext } from 'vue';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.isRoot && isActive.value) {
        _push(`<div class="absolute bottom-[10px] left-0 right-0 h-[2px] bg-primary"></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (__props.item.childrens && isOpen.value) {
        ssrRenderTeleport(_push, (_push2) => {
          _push2(`<div class="absolute bg-primary text-main border border-main z-[9999] shadow-2xl" style="${ssrRenderStyle(dropdownStyle.value)}"><ul class="border border-main border-t-primary"><!--[-->`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/default/header/menu/MenuDropdownItem.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=MenuDropdownItem-ALO0dNjY.mjs.map
