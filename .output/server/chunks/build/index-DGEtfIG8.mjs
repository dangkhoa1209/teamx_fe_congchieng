...
import { _ as _sfc_main$5 } from './hor-Gj5PQUdL.mjs';
...
import { locationTypes, timeOptions } from './data-6Amk-bZo.mjs';
      ...
      _push(ssrRenderComponent(_component_x_content_place, mergeProps({ class: "font-robo text-body" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="min-w-[400px] laptop:w-[400px]"${_scopeId}><h2 class="font-bold text-subtitle text-primary leading-[40px]"${_scopeId}>TIN T\u1EE8C N\u1ED4I B\u1EACT</h2>`);
            _push2(ssrRenderComponent(_component_x_line, null, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
...
//# sourceMappingURL=index-DGEtfIG8.mjs.map
