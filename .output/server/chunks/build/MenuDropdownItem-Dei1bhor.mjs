    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(checkPermission)(__props.item.permissions, true)) {
        ...
        if (__props.item.page) {
          ...
          if (__props.item.itemIconName) {
            _push(ssrRenderComponent(_component_Icon, {
              name: __props.item.itemIconName,
          ...
          if (__props.item.iconName) {
            _push(ssrRenderComponent(_component_Icon, {
              name: __props.item.iconName,
...
//# sourceMappingURL=MenuDropdownItem-Dei1bhor.mjs.map
