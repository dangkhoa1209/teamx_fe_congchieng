import { _ as _sfc_main$2 } from './image-BZ3fmoRC.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!__props.exclude.includes("title")) {
        _push(`<p class="font-robo font-medium text-subtitle text-primary hover:opacity-[79%] cursor-pointer line-clamp-3">${ssrInterpolate((_d = __props.news) == null ? void 0 : _d.title)}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (!__props.exclude.includes("subTitle")) {
        _push(`<p class="font-robo font-normal text-body text-justify line-clamp-3">${ssrInterpolate((_e = __props.news) == null ? void 0 : _e.subTitle)}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
//# sourceMappingURL=core-ttnb-9NqOd1-V.mjs.map
