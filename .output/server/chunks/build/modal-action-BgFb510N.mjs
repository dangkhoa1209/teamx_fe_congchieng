import { _ as _sfc_main$3 } from './button-DiwB5Aa0.mjs';
...
import { ssrRenderComponent, ssrRenderSlot, ssrRenderTeleport, ssrRenderStyle, ssrInterpolate } from 'vue/server-renderer';
import { X as XmarkSolidIcon } from './xmark-solid-47jwrLJb.mjs';
import { _ as _sfc_main$2 } from './index-Cy0o-wGa.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="fixed inset-0 z-[2000] flex items-center justify-center bg-black/40" tabindex="-1" style="${ssrRenderStyle(__props.modelValue ? null : { display: "none" })}"><div class="w-full max-w-[min(70vw,1440px)] max-h-[90vh] overflow-hidden rounded-xl bg-main shadow-lg flex flex-col transition-all duration-150 ease-out scale-100" role="dialog" aria-modal="true"><div class="flex items-center justify-between border-b border-gray-200 px-6 py-4"><h2 class="text-lg font-semibold text-gray-900 truncate">${ssrInterpolate(__props.title)}</h2><button type="button" class="rounded-full p-2 text-gray-500 hover:bg-gray-100">`);
        _push2(ssrRenderComponent(unref(XmarkSolidIcon), { class: "h-5 w-5" }, null, _parent));
...
//# sourceMappingURL=modal-action-BgFb510N.mjs.map
