...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "sticky top-0 z-[999] select-none" }, _attrs))} data-v-fb26bf32><div class="h-[75px]" data-v-fb26bf32><div class="header z-50 border-b border-primary" data-v-fb26bf32>`);
      _push(ssrRenderComponent(_component_x_content_place, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative flex justify-between items-center h-[75px] gap-[40px]" data-v-fb26bf32${_scopeId}><div class="relative overflow-hidden flex-1" data-v-fb26bf32${_scopeId}>`);
            if (unref(showPrev)) {
              _push2(`<button class="absolute left-0 top-1/2 -translate-y-1/2 w-[30px] h-[30px] rounded-full bg-main text-primary border border-primary shadow cursor-pointer z-50 flex items-center justify-center text-[16px]" data-v-fb26bf32${_scopeId}> \u2039 </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<ul class="flex gap-[52px] overflow-x-auto no-scrollbar scroll-smooth" data-v-fb26bf32${_scopeId}><!--[-->`);
            ...
            _push2(`<!--]--></ul>`);
            if (unref(showNext)) {
              _push2(`<button class="absolute right-0 top-1/2 -translate-y-1/2 w-[30px] h-[30px] rounded-full bg-main text-primary border border-primary shadow cursor-pointer z-50 flex items-center justify-center text-[16px]" data-v-fb26bf32${_scopeId}> \u203A </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div><div class="relative h-[75px] flex items-center" data-v-fb26bf32${_scopeId}>`);
            ...
            if (unref(showSearch)) {
              _push2(`<div class="absolute bottom-0 right-0 translate-y-[100%] text-main w-64" data-v-fb26bf32${_scopeId}>`);
...
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fb26bf32"]]);
...
//# sourceMappingURL=index-BSNndgB-.mjs.map
