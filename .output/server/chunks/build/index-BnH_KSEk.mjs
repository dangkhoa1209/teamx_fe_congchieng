...
import { _ as _sfc_main$1$1, a as _sfc_main$5 } from './core-ttnb-BWv5X1yH.mjs';
      ...
      _push(ssrRenderComponent(_component_x_content_place, mergeProps({ class: "font-robo text-body" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div><div class="flex flex-col laptop:flex-row laptop:items-center gap-2 w-full laptop:w-auto"${_scopeId}><label class="font-robo font-medium leading-[40px] whitespace-nowrap min-w-[100px]"${_scopeId}> Th\u1EDDi gian: </label><div class="w-full laptop:w-[200px]"${_scopeId}>`);
            _push2(ssrRenderComponent(DropdownFilter, {
                ...
                createVNode("div", { class: "w-full" }, [
                  ...
                  createVNode("div", { class: "w-full user-select-none" }, [
                    createVNode("div", { class: "flex flex-col laptop:flex-row laptop:items-center gap-4 laptop:gap-[40px] w-full" }, [
                      createVNode("div", { class: "flex flex-col laptop:flex-row laptop:items-center gap-2 w-full laptop:w-auto" }, [
...
//# sourceMappingURL=index-BnH_KSEk.mjs.map
