      ...
      _push(ssrRenderComponent(_component_x_content_place, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div></div></div><div class="w-[100%] laptop:w-[22%] flex flex-col gap-3 tablet:gap-6"${_scopeId}><p class="font-medium text-subtitle"${_scopeId}>DANH M\u1EE4C</p><p class="font-normal text-body cursor-pointer"${_scopeId}> Gi\u1EDBi thi\u1EC7u v\u1EC1 chuy\xEAn trang </p><p class="font-normal text-body cursor-pointer"${_scopeId}> Ti\u1EC1m n\u0103ng ph\xE1t tri\u1EC3n </p><p class="font-normal text-body cursor-pointer"${_scopeId}> V\u0103n h\xF3a c\u1ED3ng chi\xEAng </p><p class="font-normal text-body cursor-pointer"${_scopeId}> Tin t\u1EE9c - S\u1EF1 ki\u1EC7n </p><p class="font-normal text-body cursor-pointer"${_scopeId}>H\u1EE3p t\xE1c</p></div><div class="w-[100%] laptop:w-[30%] flex flex-col gap-3 tablet:gap-6"${_scopeId}><p class="font-medium text-subtitle"${_scopeId}>LI\xCAN H\u1EC6</p><p class="font-normal text-body"${_scopeId}> Ban qu\u1EA3n l\xFD Chuy\xEAn trang th\xF4ng tin \u0111i\u1EC7n t\u1EED c\u1ED3ng chi\xEAng t\u1EC9nh L\xE2m \u0110\u1ED3ng </p><p class="font-normal text-body"${_scopeId}>\u0110\u1ECBa ch\u1EC9: Ph\xF2ng v\u0103n h\xF3a x\xE3 h\u1ED9i x\xE3 L\u1EA1c D\u01B0\u01A1ng</p><p class="font-normal text-body"${_scopeId}>S\u1ED1 \u0111i\u1EC7n tho\u1EA1i: 0969 856 159</p><p class="font-normal text-body"${_scopeId}>Email: haint2.lacduong@lamdong.gov.vn</p></div></div>`);
            _push2(ssrRenderComponent(_component_x_space, { height: 58 }, null, _parent2, _scopeId));
            ...
            return [
              ...
              createVNode("div", { class: "flex gap-16 flex-col laptop:flex-row" }, [
                createVNode("div", { class: "flex flex-col justify-between gap-8 w-[100%] laptop:w-[43%]" }, [
                ...
                createVNode("div", { class: "w-[100%] laptop:w-[30%] flex flex-col gap-3 tablet:gap-6" }, [
                  createVNode("p", { class: "font-medium text-subtitle" }, "LI\xCAN H\u1EC6"),
                  createVNode("p", { class: "font-normal text-body" }, " Ban qu\u1EA3n l\xFD Chuy\xEAn trang th\xF4ng tin \u0111i\u1EC7n t\u1EED c\u1ED3ng chi\xEAng t\u1EC9nh L\xE2m \u0110\u1ED3ng "),
                  createVNode("p", { class: "font-normal text-body" }, "\u0110\u1ECBa ch\u1EC9: Ph\xF2ng v\u0103n h\xF3a x\xE3 h\u1ED9i x\xE3 L\u1EA1c D\u01B0\u01A1ng"),
                  createVNode("p", { class: "font-normal text-body" }, "S\u1ED1 \u0111i\u1EC7n tho\u1EA1i: 0969 856 159"),
                  createVNode("p", { class: "font-normal text-body" }, "Email: haint2.lacduong@lamdong.gov.vn")
                ])
              ]),
              createVNode(_component_x_space, { height: 58 }),
...
//# sourceMappingURL=index-CsOzwFyw.mjs.map
