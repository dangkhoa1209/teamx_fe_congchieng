...
import { _ as _sfc_main$3 } from './space-vXaoViff.mjs';
import { _ as _sfc_main$4 } from './line-Cl7qy73P.mjs';
import { _ as _sfc_main$5 } from './image-DeCRukUU.mjs';
import { _ as _sfc_main$6 } from './core-ttnb-hoiwhzfc.mjs';
import { _ as _sfc_main$7 } from './hor-Gj5PQUdL.mjs';
...
import { _ as _sfc_main$8 } from './ver-BHFqHk9E.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_x_core_ttnb = _sfc_main$6;
      const _component_x_page_news_thumb_hor = _sfc_main$7;
      const _component_x_core_ttk = _sfc_main$1;
      const _component_x_page_news_thumb_ver = _sfc_main$8;
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (unref(newsData)) {
              ...
              _push2(ssrRenderComponent(_component_x_line, { className: "" }, null, _parent2, _scopeId));
              _push2(`<section class="tablet:min-w-[400px] block laptop:hidden"${_scopeId}><div${_scopeId}><h2 class="font-bold text-subtitle text-primary mt-5 leading-[40px]"${_scopeId}> TIN T\u1EE8C N\u1ED4I B\u1EACT </h2>`);
              _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
              ...
              _push2(ssrRenderComponent(_component_x_space, { height: 80 }, null, _parent2, _scopeId));
              _push2(`</section><section class="w-full hidden laptop:block"${_scopeId}><div${_scopeId}><h2 class="font-bold text-subtitle text-primary mt-5 leading-[40px]"${_scopeId}>TIN T\u1EE8C N\u1ED4I B\u1EACT</h2>`);
              _push2(ssrRenderComponent(_component_x_line, { className: "" }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_x_core_ttnb, null, {
                default: withCtx(({ items }, _push3, _parent3, _scopeId2) => {
            ...
            return [
              ...
              unref(newsData) ? (openBlock(), createBlock("div", {
                ...
                createVNode("section", null, [
                  ...
                  createVNode(_component_x_line, { className: "" }),
                  createVNode("section", { class: "tablet:min-w-[400px] block laptop:hidden" }, [
                    createVNode("div", null, [
                ...
                createVNode("section", { class: "w-full hidden laptop:block" }, [
                  createVNode("div", null, [
                    createVNode("h2", { class: "font-bold text-subtitle text-primary mt-5 leading-[40px]" }, "TIN T\u1EE8C N\u1ED4I B\u1EACT"),
                    createVNode(_component_x_line, { className: "" }),
                    createVNode(_component_x_space, { height: 40 }),
...
//# sourceMappingURL=index-DopE5e2z.mjs.map
