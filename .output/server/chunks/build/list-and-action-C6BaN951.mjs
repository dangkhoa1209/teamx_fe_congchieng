...
import { _ as _sfc_main$4 } from './modal-action-Q10xIrEA.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const handleSave = async () => {
      ...
      console.log("response?.data?.value", (_a = response == null ? void 0 : response.data) == null ? void 0 : _a.value);
      const { data, success } = ((_b = response == null ? void 0 : response.data) == null ? void 0 : _b.value) || {
        data: null,
        success: false
      };
...
//# sourceMappingURL=list-and-action-C6BaN951.mjs.map
