...
import { _ as _sfc_main$4 } from './index-BzusrdnL.mjs';
      ...
      _push(ssrRenderComponent(_component_x_content_place, mergeProps({ class: "font-robo text-primary" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(unref(FaxIcon), { class: "h-6 w-6 laptop:w-8 laptop:h-8" }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(_component_x_form, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</div>`);
                  _push3(ssrRenderComponent(_component_x_form_input, {
                    modelValue: unref(formData).mail,
                    "onUpdate:modelValue": ($event) => unref(formData).mail = $event,
                    label: "Email",
                    name: "email",
                    rules: "required",
                    required: ""
              ...
              createVNode("div", { class: "flex flex-col laptop:flex-row gap-[40px]" }, [
                createVNode("div", { class: "laptop:w-[35%]" }, [
                  ...
                  createVNode("div", { class: "flex flex-col gap-[30px] text-body font-normal" }, [
                    ...
                    createVNode("div", { class: "flex items-center gap-5" }, [
                      createVNode(unref(FaxIcon), { class: "h-6 w-6 laptop:w-8 laptop:h-8" }),
...
//# sourceMappingURL=index-C1bCbAzW.mjs.map
