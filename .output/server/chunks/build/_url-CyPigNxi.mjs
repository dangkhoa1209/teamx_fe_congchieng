...
import { c as useNuxtApp, d as useRuntimeConfig, u as useRouter, i as fetchDefaults, j as useRequestFetch } from './server.mjs';
...
async function $api(source, options = {}, showError = true) {
  ...
  try {
    ...
    console.log("e", e);
    $toast().error(e.message || "L\u1ED7i k\u1EBFt n\u1ED1i m\xE1y ch\u1EE7");
    throw e;
  }
}
const auth = {
...
//# sourceMappingURL=_url-CyPigNxi.mjs.map
