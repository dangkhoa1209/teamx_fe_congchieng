import { _ as _sfc_main$1 } from './button-DiwB5Aa0.mjs';
import { toRefs, ref, computed, watch, mergeProps, unref, withCtx, createTextVNode, toDisplayString, createVNode, withModifiers, createBlock, createCommentVNode, openBlock, createElementBlock, createElementVNode, nextTick, useSSRContext } from 'vue';
...
function render(_ctx, _cache) {
  return openBlock(), createElementBlock("svg", _hoisted_1, [..._cache[0] || (_cache[0] = [
    createElementVNode("path", { d: "M13 19c0 .7.13 1.37.35 2H5a2 2 0 0 1-2-2V5c0-1.1.9-2 2-2h14a2 2 0 0 1 2 2v8.35c-.63-.22-1.3-.35-2-.35V5H5v14zm.96-6.71-2.75 3.54-1.96-2.36L6.5 17h6.85c.4-1.12 1.12-2.09 2.05-2.79zM20 18v-3h-2v3h-3v2h3v3h2v-3h3v-2z" }, null, -1)
  ])]);
}
const ImagePlusOutline = { render };
const _sfc_main = {
  __name: "image-picker",
        ...
        default: withCtx(({ field, errors, handleChange }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (!imageSrc.value && !croppedData.value) {
              ...
              _push2(ssrRenderComponent(unref(ImagePlusOutline), { class: "w-6 h-6 mb-1 text-gray-400" }, null, _parent2, _scopeId));
              if (!isDragging.value) {
            ...
            return [
              createVNode("div", {
                ...
                !imageSrc.value && !croppedData.value ? (openBlock(), createBlock("label", {
                  ...
                  createVNode(unref(ImagePlusOutline), { class: "w-6 h-6 mb-1 text-gray-400" }),
...
//# sourceMappingURL=image-picker-BpOBlaQL.mjs.map
