...
import _sfc_main$1 from './list-and-action-DKNGTtPP.mjs';
...
import './input-fliter-BDL6bdP5.mjs';
import './_url-2PNiK-Su.mjs';
import './_store-Ndlczi3l.mjs';
import '@vue/shared';

const _sfc_main = {
  __name: "xa-dinh-trang-thuong",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        title: "Tin t\u1EE9c n\u1ED5i b\u1EADt X\xE3 \u0110inh Trang Th\u01B0\u1EE3ng",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/tin-tuc-su-kien/tin-noi-bat/xa-dinh-trang-thuong.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=xa-dinh-trang-thuong-GiIPHsBb.mjs.map
