...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full pb-12 laptop:pb-16" }, _attrs))} data-v-e7e4ba4f>`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e7e4ba4f"]]);

export { __nuxt_component_0 as _ };
//# sourceMappingURL=slide-BTYZyl4M.mjs.map
