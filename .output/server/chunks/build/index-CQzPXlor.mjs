...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_x_content_place, mergeProps({ class: "flex items-center justify-center" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="mt-[100px] text-center"${_scopeId}><p class="text-title font-semibold"${_scopeId}>CH\xC0O M\u1EEANG \u0110\u1EBEN TRANG QU\u1EA2N L\xDD</p></div>`);
      } else {
        return [
          createVNode("div", { class: "mt-[100px] text-center" }, [
            createVNode("p", { class: "text-title font-semibold" }, "CH\xC0O M\u1EEANG \u0110\u1EBEN TRANG QU\u1EA2N L\xDD")
          ])
        ];
      }
    }),
...
//# sourceMappingURL=index-CQzPXlor.mjs.map
