  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!__props.exclude.includes("title")) {
        _push(`<p class="font-robo font-medium text-subtitle text-primary hover:opacity-[79%] cursor-pointer">${ssrInterpolate(((_c = __props.news) == null ? void 0 : _c.title) || "Gi\u1EEF g\xECn b\u1EA3n s\u1EAFc v\u0103n ho\xE1 qua du l\u1ECBch c\u1ED3ng chi\xEAng \u1EDF L\xE2m \u0110\u1ED3ng")}</p>`);
      } else {
        _push(`<!---->`);
      }
      if (!__props.exclude.includes("subTitle")) {
        _push(`<p class="font-robo font-normal text-body text-justify">${ssrInterpolate(((_d = __props.news) == null ? void 0 : _d.subTitle) || "X\xE2y d\u1EF1ng \u0111i\u1EC3m check-in v\u0103n ho\xE1 nh\u01B0 c\u1ED5ng l\xE0ng truy\u1EC1n th\u1ED1ng, t\u01B0\u1EE3ng ngh\u1EC7 nh\xE2n, v\u01B0\u1EDDn nh\u1EA1c c\u1EE5. K\u1EBFt h\u1EE3p ngh\u1EC7 thu\u1EADt tr\xECnh di\u1EC5n \xE1nh s\xE1ng & \xE2m thanh C\u1ED3ng chi\xEAng cho du l\u1ECBch \u0111\xEAm")}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(featuredSlots).length && unref(show)) {
        _push(`<div><p class="text-body">Ch\u01B0a c\xF3 tin t\u1EE9c s\u1EF1 ki\u1EC7n n\u1ED5i b\u1EADt</p></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=core-ttnb-BkzLb_3Y.mjs.map
