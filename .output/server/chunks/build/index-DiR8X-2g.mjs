...
import { _ as _sfc_main$4 } from './line-ByzM3RBl.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$5 } from './core-ttnb-D64tFZl7.mjs';
import { computed, ref, watch, mergeProps, withCtx, unref, createVNode, createBlock, openBlock, Fragment, renderList, createCommentVNode, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderList } from 'vue/server-renderer';
import _sfc_main$3 from './input-fliter-BSjNd1hz.mjs';
import DropdownFilter from './dropdown-filter-DpFRgytJ.mjs';
      ...
      _push(ssrRenderComponent(_component_x_content_place, mergeProps({ class: "font-robo text-body" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="w-full user-select-none"${_scopeId}><div class="flex flex-col laptop:flex-row laptop:items-center gap-4 laptop:gap-[40px] w-full"${_scopeId}><div class="flex laptop:items-center gap-2 w-full laptop:w-auto"${_scopeId}><label class="font-robo font-medium leading-[40px] whitespace-nowrap min-w-[100px]"${_scopeId}> T\xECm ki\u1EBFm: </label><div class="w-full laptop:w-[200px]"${_scopeId}>`);
            ...
            _push2(`</div></div><div class="flex laptop:items-center gap-2 w-full laptop:w-auto"${_scopeId}><label class="font-robo font-medium leading-[40px] whitespace-nowrap min-w-[100px]"${_scopeId}> Th\u1EDDi gian: </label><div class="w-full laptop:w-[200px]"${_scopeId}>`);
            _push2(ssrRenderComponent(DropdownFilter, {
            ...
            _push2(`<!--]-->`);
            if (!unref(lists).data.length && unref(show)) {
              _push2(`<p class="text-body text-center"${_scopeId}> Kh\xF4ng t\xECm th\u1EA5y tin t\u1EE9c s\u1EF1 ki\u1EC7n </p>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div>`);
              ...
              createVNode("div", { class: "flex gap-[40px] flex-col laptop:flex-row" }, [
                createVNode("div", { class: "w-full" }, [
                  ...
                  createVNode("div", { class: "w-full user-select-none" }, [
                    createVNode("div", { class: "flex flex-col laptop:flex-row laptop:items-center gap-4 laptop:gap-[40px] w-full" }, [
                      createVNode("div", { class: "flex laptop:items-center gap-2 w-full laptop:w-auto" }, [
                      ...
                      createVNode("div", { class: "flex laptop:items-center gap-2 w-full laptop:w-auto" }, [
                        createVNode("label", { class: "font-robo font-medium leading-[40px] whitespace-nowrap min-w-[100px]" }, " Th\u1EDDi gian: "),
                        createVNode("div", { class: "w-full laptop:w-[200px]" }, [
                          createVNode(DropdownFilter, {
                            modelValue: unref(filter).time,
                            "onUpdate:modelValue": ($event) => unref(filter).time = $event,
                  ...
                  createVNode("div", { class: "flex flex-col gap-[40px]" }, [
                    ...
                    !unref(lists).data.length && unref(show) ? (openBlock(), createBlock("p", {
                      key: 0,
                      class: "text-body text-center"
                    }, " Kh\xF4ng t\xECm th\u1EA5y tin t\u1EE9c s\u1EF1 ki\u1EC7n ")) : createCommentVNode("", true)
                  ]),
...
//# sourceMappingURL=index-DiR8X-2g.mjs.map
