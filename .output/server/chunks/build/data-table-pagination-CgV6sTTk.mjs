...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-bb9fd2ec><button type="button" class="inline-flex items-center gap-2 rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary/40" data-v-bb9fd2ec>`);
      _push(ssrRenderComponent(unref(DotsVerticalIcon), { class: "h-4 w-4" }, null, _parent));
      _push(`<p class="whitespace-nowrap" data-v-bb9fd2ec>Thao t\xE1c</p></button>`);
      if (unref(open)) {
        _push(`<div class="absolute left-0 translate-x-[-105%] w-44 origin-top-right rounded-xl border border-gray-100 bg-main shadow-lg ring-1 ring-black/5 focus:outline-none" data-v-bb9fd2ec><ul class="py-2 text-sm text-gray-700" data-v-bb9fd2ec><!--[-->`);
        ssrRenderList(__props.actions, (action) => {
          _push(`<li data-v-bb9fd2ec><button type="button" class="${ssrRenderClass([unref(actionButtonClasses)(action), "flex w-full items-center gap-2 px-4 py-2 text-left transition-colors"])}" data-v-bb9fd2ec><span data-v-bb9fd2ec>${ssrInterpolate(action.label)}</span></button></li>`);
        });
        _push(`<!--]--></ul></div>`);
      } else {
        _push(`<!---->`);
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-bb9fd2ec"]]);
const _sfc_main$1 = {
  __name: "data-table",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=data-table-pagination-CgV6sTTk.mjs.map
