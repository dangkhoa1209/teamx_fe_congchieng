...
import _sfc_main$2 from './MenuDropdownItem-BlrTAlO6.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "sticky top-0 z-[999] select-none" }, _attrs))} data-v-583b7a60><div class="h-[75px]" data-v-583b7a60><div class="header z-50" data-v-583b7a60>`);
      _push(ssrRenderComponent(_component_x_content_place, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative flex justify-between items-center h-[75px] gap-[40px]" data-v-583b7a60${_scopeId}><div class="relative overflow-hidden flex-1" data-v-583b7a60${_scopeId}>`);
            if (unref(showPrev)) {
              _push2(`<button class="absolute left-0 top-1/2 -translate-y-1/2 w-[30px] h-[30px] rounded-full bg-main text-primary border border-primary shadow cursor-pointer z-50 flex items-center justify-center text-[16px]" data-v-583b7a60${_scopeId}> \u2039 </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`<ul class="flex gap-[52px] overflow-x-auto no-scrollbar scroll-smooth" data-v-583b7a60${_scopeId}><!--[-->`);
            ...
            _push2(`<!--]--></ul>`);
            if (unref(showNext)) {
              _push2(`<button class="absolute right-0 top-1/2 -translate-y-1/2 w-[30px] h-[30px] rounded-full bg-main text-primary border border-primary shadow cursor-pointer z-50 flex items-center justify-center text-[16px]" data-v-583b7a60${_scopeId}> \u203A </button>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div>`);
...
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-583b7a60"]]);
...
//# sourceMappingURL=index-CbamGqyX.mjs.map
