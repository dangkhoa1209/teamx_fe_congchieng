...
import { _ as _sfc_main$3 } from './ver-BHFqHk9E.mjs';
import { _ as _sfc_main$4 } from './modal-action-DrQ_qsBz.mjs';
import { ref, nextTick, watch, withCtx, unref, isRef, createVNode, createTextVNode, toDisplayString, createBlock, openBlock, Fragment, renderList, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    const handleSave = async () => {
      ...
      if (!newsIdSelected.value) {
        $toast().error("Vui l\xF2ng ch\u1ECDn tin t\u1EE9c - s\u1EF1 ki\u1EC7n");
      }
      ...
      if (success) {
        $toast().success("C\u1EADp nh\u1EADt tin n\u1ED5i b\u1EADt th\xE0nh c\xF4ng");
        reset();
        close();
        fetchFeatured();
      }
            ...
            _push2(ssrRenderComponent(_component_x_modal_action, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</div> newsIdSelected: ${ssrInterpolate(unref(newsIdSelected))} positionSelected: ${ssrInterpolate(unref(positionSelected))} <div class="grid grid-cols-1 laptop:grid-cols-3 gap-x-[40px] gap-y-[50px] mt-[40px]"${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(lists).data, (item) => {
                    _push3(`<div class="${ssrRenderClass([{
                      "news-item-active": unref(newsIdSelected) === item._id
                  ...
                  return [
                    ...
                    createTextVNode(" newsIdSelected: " + toDisplayString(unref(newsIdSelected)) + " positionSelected: " + toDisplayString(unref(positionSelected)) + " ", 1),
...
//# sourceMappingURL=list-and-action-BAl9BVWT.mjs.map
