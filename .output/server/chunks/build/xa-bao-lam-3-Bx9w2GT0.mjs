  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        title: "Tin t\u1EE9c n\u1ED5i b\u1EADt X\xE3 B\u1EA3o L\xE2m 3",
        type: "xa-bao-lam-3"
      }, _attrs), null, _parent));
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/admin/tin-tuc-su-kien/tin-noi-bat/xa-bao-lam-3.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=xa-bao-lam-3-Bx9w2GT0.mjs.map
