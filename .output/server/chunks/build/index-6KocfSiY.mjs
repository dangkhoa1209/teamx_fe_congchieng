...
import { _ as _sfc_main$3 } from './space-CZvezhho.mjs';
import { _ as _sfc_main$4 } from './line-CYB7w7Wn.mjs';
import { _ as _sfc_main$5 } from './image-CfPwRy5O.mjs';
import { _ as _sfc_main$6 } from './hor-D3kLr8D8.mjs';
...
import { _ as _sfc_main$7 } from './ver-BGnOEYW7.mjs';
import { _ as _sfc_main$8 } from './core-ttnb-hoiwhzfc.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_x_page_news_thumb_hor = _sfc_main$6;
      const _component_x_core_ttk = _sfc_main$1;
      const _component_x_page_news_thumb_ver = _sfc_main$7;
      const _component_x_core_ttnb = _sfc_main$8;
      _push(ssrRenderComponent(_component_x_content_place, mergeProps({ class: "font-robo text-body" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
            if (unref(newsData)) {
              _push2(`<div class="flex gap-[40px]"${_scopeId}><div${_scopeId}><h2 class="font-bold text-title-news text-primary"${_scopeId}>${ssrInterpolate(unref(newsData).title)}</h2></div><div class="min-w-[400px] w-[400px]"${_scopeId}></div></div>`);
            } else {
              _push2(`<!---->`);
            }
            if (unref(newsData)) {
              _push2(`<div class="flex gap-[40px]"${_scopeId}><section${_scopeId}><div class="flex justify-between align-middle mt-5 leading-[40px]"${_scopeId}><div${_scopeId}><span${_scopeId}>${ssrInterpolate(("$formatter" in _ctx ? _ctx.$formatter : unref(__unimport_$formatter))().formatVNTime(unref(newsData).createdAt))}</span></div><div class="flex gap-2"${_scopeId}><span${_scopeId}>icon</span><span${_scopeId}>icon</span><span${_scopeId}>icon</span></div></div>`);
              ...
              _push2(ssrRenderComponent(_component_x_line, { className: "" }, null, _parent2, _scopeId));
              _push2(`<section class="min-w-[400px] block laptop:hidden"${_scopeId}><div${_scopeId}><h2 class="font-bold text-subtitle text-primary mt-5 leading-[40px]"${_scopeId}> TIN T\u1EE8C N\u1ED4I B\u1EACT </h2>`);
              _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
              ...
              _push2(ssrRenderComponent(_component_x_page_news_thumb_hor, { exclude: ["subTitle"] }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_x_page_news_thumb_hor, { exclude: ["subTitle"] }, null, _parent2, _scopeId));
              _push2(`</div></div></section><h2 class="font-bold text-subtitle text-primary mt-5 leading-[40px]"${_scopeId}>TIN T\u1EE8C KH\xC1C</h2>`);
              _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
              ...
              _push2(ssrRenderComponent(_component_x_space, { height: 80 }, null, _parent2, _scopeId));
              _push2(`</section><section class="min-w-[400px] w-[400px] hidden laptop:block"${_scopeId}><div${_scopeId}><h2 class="font-bold text-subtitle text-primary mt-5 leading-[40px]"${_scopeId}>TIN T\u1EE8C N\u1ED4I B\u1EACT</h2>`);
              _push2(ssrRenderComponent(_component_x_line, { className: "" }, null, _parent2, _scopeId));
              _push2(ssrRenderComponent(_component_x_space, { height: 40 }, null, _parent2, _scopeId));
            ...
            return [
              ...
              unref(newsData) ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "min-w-[400px] w-[400px]" })
              ])) : createCommentVNode("", true),
              unref(newsData) ? (openBlock(), createBlock("div", {
                key: 1,
                class: "flex gap-[40px]"
                ...
                createVNode("section", null, [
                  createVNode("div", { class: "flex justify-between align-middle mt-5 leading-[40px]" }, [
                    createVNode("div", null, [
                      createVNode("span", null, toDisplayString(("$formatter" in _ctx ? _ctx.$formatter : unref(__unimport_$formatter))().formatVNTime(unref(newsData).createdAt)), 1)
                    ]),
                    createVNode("div", { class: "flex gap-2" }, [
                      createVNode("span", null, "icon"),
                      createVNode("span", null, "icon"),
                      createVNode("span", null, "icon")
                    ])
                  ]),
                  ...
                  createVNode(_component_x_line, { className: "" }),
                  createVNode("section", { class: "min-w-[400px] block laptop:hidden" }, [
                    createVNode("div", null, [
                ...
                createVNode("section", { class: "min-w-[400px] w-[400px] hidden laptop:block" }, [
                  createVNode("div", null, [
                    createVNode("h2", { class: "font-bold text-subtitle text-primary mt-5 leading-[40px]" }, "TIN T\u1EE8C N\u1ED4I B\u1EACT"),
                    createVNode(_component_x_line, { className: "" }),
                    createVNode(_component_x_space, { height: 40 }),
...
//# sourceMappingURL=index-6KocfSiY.mjs.map
