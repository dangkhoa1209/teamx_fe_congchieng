...
import { ref, computed, resolveComponent, withCtx, unref, createVNode, createBlock, createCommentVNode, toDisplayString, openBlock, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'vue/server-renderer';
import { useRoute } from 'vue-router';
import { C as ChevronRightIcon } from './chevron-right-Dd6J472h.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              ...
              __props.item.childrens ? (openBlock(), createBlock(unref(ChevronRightIcon), {
                key: 0,
                class: ["w-5 h-5 transition-transform", open.value ? "rotate-90" : ""]
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("layouts/admin/header/menu/MobileMenuItem.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=MobileMenuItem-DnRvrG3s.mjs.map
