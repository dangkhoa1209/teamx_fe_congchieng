<template>
  <Teleport to="body">
    ...
    >
      <div
        class="w-full max-w-[min(70vw,1440px)] max-h-[90vh] overflow-hidden rounded-xl bg-main shadow-lg flex flex-col transition-all duration-150 ease-out scale-100"
        role="dialog"
        aria-modal="true"
      >
